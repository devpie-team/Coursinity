...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-[999] max-h-[--radix-select-content-available-height] min-w-[8rem] overflow-y-auto overflow-x-hidden rounded-2xl border bg-white text-popover-foreground shadow-md',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative h-[46px] flex w-full cursor-pointer select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-body3 outline-none transition-colors',
      'hover:bg-secondary-300 focus:bg-accent focus:text-accent-foreground',
      'data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      ' data-[state=checked]:bg-secondary-300',
      className
    )}
    {...props}>

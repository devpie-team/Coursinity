...
export const ImpactSectionNew = () => {
  ...
  const animations = [
    { animation: animation1, className: 'absolute w-[362px] h-[280px] top-[146px] left-0' },
    { animation: animation2, className: 'absolute w-[362px] h-[308px] bottom-[27px] right-[16px]' },
    { animation: animation3, className: 'absolute w-[253px] h-[65px] top-[22px] left-[162px]' },
    { animation: animation4, className: 'absolute w-[296px] h-[65px] bottom-[231px] right-[390px]' },
    { animation: animation5, className: 'absolute w-[156px] h-[52px] bottom-[151px] left-[421px]' },
    { animation: animation6, className: 'absolute w-[309px] h-[223px] top-[35px] right-[556px]' },
    { animation: animation7, className: 'absolute w-[269px] h-[160px] top-[93px] left-[488px]' },
    { animation: animation8, className: 'absolute w-[362px] w-[362px] h-[316px] bottom-0 left-[619px]' },
    { animation: animation5, className: 'absolute w-[156px] h-[52px] top-[133px] right-[251px]' }
  ]

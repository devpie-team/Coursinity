    ...
    return (
      <div className="flex flex-col">
        ...
        <input
          type={type}
          className={cn(
            'flex focus:outline-none h-15 w-full text-md rounded-2xl border  bg-white px-5 py-[18px]   placeholder:text-opacity-60  disabled:pointer-events-none disabled:opacity-50 hover:border-black focus:border-black ',

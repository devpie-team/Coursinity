...
const buttonVariants = cva('rounded-full leading-4 font-medium', {
  variants: {
    variant: {
      ...
      secondary:
        'bg-white backdrop-blur-[40px] text-black  hover:text-white hover:shadow-[0px_12px_40px_0px_#A578F240] hover:bg-primary-purple active:bg-transparent active:bg-[#8759D5] disabled:pointer-events-none  disabled:bg-opacity-30 disabled:text-opacity-40 disabled:text-white'
    },
    size: {
      md: 'h-14 px-6 py-5',
      lg: 'h-16 px-8 py-5'

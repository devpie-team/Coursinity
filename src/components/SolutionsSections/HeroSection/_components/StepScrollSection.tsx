...
const StepScroll = () => {
  ...
  return (
    <div
      className="flex flex-col bg-white rounded-[40px] mx-8 py-[40px] border border-secondary-400 gap-10 items-center max-md:px-4 max-md:pb-20 pt-[120px] max-lg:pt-[80px]"
      ref={wrapperRef}>

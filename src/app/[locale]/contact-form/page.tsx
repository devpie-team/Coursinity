  ...
  return (
    <>
      ...
      <main className="flex  px-[116px] py-[101px] pb-[148px] bg-contact-gradient  justify-center items-center max-[1100px]:px-6 max-lg:py-20 ">
        <div className="flex border border-black max-w-[1210px] border-opacity-10 rounded-3xl max-md:flex-col ">
          <ContactVisual
            className={cn(
          ...
          <ContactForm
            className={cn(
              'p-8 min-w-[720px] max-lg:p-5 max-md:min-w-[343px] max-md:max-w-full order-2 max-md:order-1 z-10 bg-white rounded-e-3xl  max-md:rounded-3xl max-1250:min-w-[450px] max-1250:max-w-[450px] max-1350:max-w-[550px] max-1350:min-w-[550px]',
